...
Type TDebugger
	...
	Method StoreMessage(name:String, data:String, sent:Byte)
		...
		LockMutex(Self._mutex)
		Self._messageStack.AddLast(New TDebuggerMessage(name, data, sent))
		UnlockMutex(Self._mutex)
	EndMethod
	...
	Function DebuggerMain:Object(data:Object)
		...
		instance._window = CreateWindow("BlitzMax LSP Debug", 0, 8,  ..
			...
			WINDOW_RESIZABLE | WINDOW_TITLEBAR | WINDOW_MENU)
...
Type TDebugger
	...
	Method Log(text:String); EndMethod
	Method StoreMessage(name:String, data:String, sent:Byte); EndMethod
...
Function AddDebuggerLog(text:String)
	Debugger.Log(text)
End Function

Function AddDebuggerMessage(name:String, data:String, sent:Byte)
	Debugger.StoreMessage(name, data, sent)
End Function
